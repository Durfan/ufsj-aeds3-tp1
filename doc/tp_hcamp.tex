...
\begin{table}[!h]
	...
	\begin{tabular}{llll}
		\toprule 
		Entrada $n$ & $gettime()$ & $ru\_utime()$ & $ru\_stime()$ \\ 
		\midrule
		100 & 85628 ms & 10348 ms & 0 \\
		1000 & 3432594 ms & 559505 ms & 6626 ms \\
		10000 & 64448993 ms & 62s 729319 ms & 9990 ms \\ 
		\bottomrule
		\footnotesize Fonte: autores
	\end{tabular}
\end{table}
...
\begin{figure}[!h]
	...
	xtick={1000,2500,5000,7500,10000},
	ytick={5000,10000,25000,50000,70000},
	grid style=dashed,
	legend style={draw=none},
	]
	...
	coordinates{
		(100,85.628)(1000,3432.594)(10000,64448.993)
	};
	\legend{gettime}
	\end{axis}
	\end{tikzpicture}
