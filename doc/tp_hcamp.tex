...
\begin{figure}[!h]
	...
	ytick={20000,40000,60000,80000,100000,120000,140000,160000},
	xmajorgrids=true,
	ymajorgrids=true,
	grid style=dashed,
	legend style={draw=none},
	...
	coordinates{
		(100,91.751)(500,1418.852)(1000,2144.396)(2000,5350.661)(4000,11219.083)
		(8000,40450.777)(16000,167955.974)
	};
	\legend{gettime(),$n^2$}
	\end{axis}
	\end{tikzpicture}
